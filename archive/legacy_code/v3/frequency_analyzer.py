...
class FrequencyAnalyzer:
    ...
    Pure dataclass with no __init__ override.
    """
    ...
    def get_frequency_analysis(self) -> Dict:
        ...
        return {'word_frequencies': self.word_frequencies, 'chunk_line_positions': self.chunk_line_positions,
            'total_lines'         : self.total_lines, 'total_unique_words': self.total_unique_words,
    ...
    def meets_operation_criteria(self, word: str, target_count: int, operation: str) -> bool:
        ...
        operations_map = {'>=': freq >= target_count, '>': freq > target_count, '==': freq == target_count,
            '<='              : freq <= target_count, '<': freq < target_count}
