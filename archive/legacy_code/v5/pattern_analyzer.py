...
class PatternAnalyzer:
    ...
    def _validate_and_recalculate_positions(self, filtered_lines: List[List[str]],
        ...
        Args:
            filtered_lines: Clean, filtered text from Stage 3 (List of List[str])
        ...
        for chunk, original_positions in chunk_line_positions.items():
            ...
            for line_num in original_positions:
                if line_num < len(filtered_lines):
                    # FIXED: Join the list of strings to create searchable text
    ...
    def _find_chunk_in_filtered_text(self, chunk: str, filtered_lines: List[List[str]]) -> List[int]:
        ...
        Args:
            ...
            filtered_lines: Filtered text lines to search (List of List[str])
